...
$(document).ready(function(){
    $(".delete_studyarea").click(function() {
        var row = $(this);
        var studyareaID = $(this).attr("id");
        var answer=confirm("Вы действительно хотите удалить эту область?");
        if(answer){
            //$.getJSON("/admin/_universities.php", {
            $.post("/admin/_studyareas.php", { 'delete': studyareaID}, function() {
