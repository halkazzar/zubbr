/**
* Zubr
* Managing university deletion in admin panel
* @package Zubr
...
$(document).ready(function(){
    $(".delete_university").click(function() {
        var row = $(this);
        var universityAlias = $(this).attr("id");
        var answer=confirm("Вы действительно хотите удалить " + universityAlias + "?");
        if(answer){
            //$.getJSON("/admin/_universities.php", {
            $.post("/admin/_universities.php", { 'delete': universityAlias}, function() {
